        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                ...
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${ctx}/user/toSettingPage" data-title="个人信息" data-icon="fa fa-gears">个人信息</a>
                    </dd>
                    <dd>
...
<#--                <#if permissions?seq_contains("10") >-->
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-street-view"></i><span class="layui-left-nav"> 图书借阅管理</span> <span class="layui-nav-more"></span></a>
                    <dl class="layui-nav-child">
<#--                        <#if permissions?seq_contains("1010")>-->
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-1"
                               data-tab="sale_chance/index" target="_self"><i class="fa fa-tty"></i><span class="layui-left-nav"> 图书借阅 </span></a>
                        </dd>
<#--                        </#if>-->
<#--                        <#if permissions?seq_contains("1020")>-->
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-2" data-tab="cus_dev_plan/index" target="_self"><i class="fa fa-ellipsis-h"></i><span class="layui-left-nav"> 我的图书 </span></a>
                        </dd>
<#--                        </#if>-->
                    </dl>
                </li>
...
<#--                <#if permissions?seq_contains("20") >-->
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-flag"></i><span class="layui-left-nav"> 借出后管理</span> <span class="layui-nav-more"></span></a><dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-3" data-tab="customer/index" target="_self"><i class="fa fa-exchange"></i><span class="layui-left-nav"> 追后图书</span></a>
                        </dd>
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-4" data-tab="customer_loss/index" target="_self"><i class="fa fa-user-times"></i><span class="layui-left-nav"> 逾期操作</span></a>
                        </dd>
                    </dl>
                </li>
<#--                </#if>-->
<#--                <#if permissions?seq_contains("30") >-->
                <li class="layui-nav-item">
                    <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-desktop"></i><span class="layui-left-nav"> 档案管理</span> <span class="layui-nav-more"></span></a>
                    <dl class="layui-nav-child">
                            <dd>
...
<#--                <#if permissions?seq_contains("60") >-->
                <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd>
                                <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-10" data-tab="data_dic/index" target="_self"><i class="fa fa-tachometer"></i><span class="layui-left-nav"> 图书管理</span></a>
                            </dd>
                                <dd>
